...
public class GraphicsSystem  extends LBUGraphics{
	...
	public ArrayList<String> arr=new ArrayList<String>(
			Arrays.asList("clock","shape","circle","equilateral","penwidth","name","image","save","load","screenshot","triangle","square","pencolor","about","pendown","penup","leftturn","rightturn","forward","backward","green","red","white","black","reset","clear"));
